"""Origin-complete: deep multiagent evidence JSON must fail closed before RecursionError."""
...
def test_load_evidence_artifact_rejects_deep_array_nest(tmp_path: Path) -> None:
